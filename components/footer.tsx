      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-wrap gap-3 justify-center justify-items-center">
          <a
            ...
            className="w-10 h-10 bg-[#6366f1]/10 border border-[#6366f1]/20 rounded-xl flex items-center justify-center text-[#6366f1] hover:bg-[#6366f1] hover:text-white transition-all duration-300"
          >
